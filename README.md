...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tridwzm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
```
git clone git@github.com:denis-mrd/container-tridwzm.git
```
